...
Function Invoke-LDAPQuery {
    ...
    Begin {
        ...
        $ldapSearcher.PropertiesToLoad.Add("msFVE-KeyPackage") | Out-Null ; 
        $ldapSearcher.PropertiesToLoad.Add("msFVE-RecoveryGuid") | Out-Null ; 
        $ldapSearcher.PropertiesToLoad.Add("msFVE-RecoveryPassword") | Out-Null ; 
        $ldapSearcher.PropertiesToLoad.Add("msFVE-VolumeGuid") | Out-Null ; 
        $results = [ordered]@{};
...
Write-Logger -Logfile $Logfile -Message  "[+] Powershell [+]"
Write-Logger -Logfile $Logfile -Message  "--"
Write-Logger -Logfile $Logfile -Message  ""
